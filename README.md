...
- The original legacy implementation was preserved in [legacy/src-legacy/visual.ts](/C:/dev/SynopticPanel/legacy/src-legacy/visual.ts) together with its old typings and API files.
